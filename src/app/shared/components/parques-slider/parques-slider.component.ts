...
@Component({
  selector: 'app-parques-slider',
  templateUrl: './parques-slider.component.html',
  styleUrls: ['./parques-slider.component.scss']
})
export class ParquesSliderComponent {
  @Input() cardArray: any[] | undefined;
  ...
  selectFunction(){
    window.open('https://api.whatsapp.com/send/?phone=19546218999&text=Hola%21+Me+gustaría+conocer+más+sobre+los+parques+de+Disney&type=phone_number&app_absent=0', '_blank')
  }
}