...
import { ionCarSportOutline, ionHomeOutline, ionCalendarOutline , ionOptionsOutline ,ionStarOutline, ionBedOutline, ionAirplaneOutline,ionPersonOutline, ionColorWandOutline,ionCashOutline, ionBoatOutline, ionEarthOutline, ionIdCardOutline, ionReaderOutline, ionPeopleOutline, ionBusinessOutline, ionDiamondOutline,ionLockClosedOutline, ionDocumentAttachOutline } from '@ng-icons/ionicons';
...
@NgModule({
  ...
  imports: [
    ...
    MatIconModule,
    MatTooltipModule,
    NgIconsModule.withIcons({ ionCarSportOutline,ionHomeOutline ,ionCalendarOutline, ionOptionsOutline, ionStarOutline, ionBedOutline, ionAirplaneOutline, ionColorWandOutline,ionPersonOutline, ionBoatOutline, ionEarthOutline, ionIdCardOutline,ionCashOutline, ionReaderOutline, ionPeopleOutline, ionBusinessOutline, ionDiamondOutline,ionLockClosedOutline, ionDocumentAttachOutline }),
  ],
  exports: [
    NavBarComponent,
    CarouselComponent,
